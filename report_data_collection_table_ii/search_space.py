...
class Search_Space: 
    ...
    def __init__(self, optimization_mode=" -O3 ", arch_dict=None, \
            ...
            max_mixed_radix=2, is_omp=False, is_avx=False, is_recursive=False, \
        ...
        self.variant_name = str(self.type_str) + \
                            ...
                            "_" + str(self.optimization_mode[2:len(self.optimization_mode)])
        self.set_build_cmd()
